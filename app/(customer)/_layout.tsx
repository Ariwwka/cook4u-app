...
export default function CustomerLayout() {
  return (
    <Tabs screenOptions={{
      ...
      tabBarStyle: { borderTopColor: '#f3f4f6', borderTopWidth: 1, backgroundColor: '#fff', height: 56, paddingBottom: 6, paddingTop: 4 },
      ...
      <Tabs.Screen name="account" options={{ title: 'Account', tabBarIcon: ({ focused }) => <TabIcon emoji="👤" focused={focused} /> }} />
